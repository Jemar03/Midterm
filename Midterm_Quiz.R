...
parser$add_argument("-pic", help = "Local File Directory of img to augment")
parser$add_argument("-H",type="integer", help = "Height")
parser$add_argument("-W",type="integer", help = "Width")
parser$add_argument("-grey" ,type="logical",help = "To grayscale an img")
...
#output 
print(augmented(args$pic,args$H,args$W,args$grey,args$angle))